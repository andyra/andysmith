...
const Project = () => {
  return (
    <>
      <header className="space-y-[2vmax] py-[8vmax] bg-ground-accent2">
      ...
      <Content className="max-w-screen-2xl space-y-[8vmax]">
        {[...Array(8)].map((e, i) => (
          <section className="space-y-[2vmax]" key={i}>
            <Divider />
            <p className="flex items-baseline gap-12 font-medium text-2xl max-w-screen-lg relative">
              <span className="block font-normal text-lg text-accent absolute -left-16 -translate-x-full">
                0{i + 1}
              </span>
