        ...
        <Section title="Figuring it out" columns>
          <SubSection title="Start without (too much) judgement">
            <p>
              ...
              allowing you to quickly dump ideas on a screen without getting
              lost in the details.
            </p>
          ...
          <SubSection title="Narrow down on the good bits">
            ...
            <p>
              After narrowing in on a couple of solid options, we wanted to get
              a better sense for how each might work in real life&mdash;
              something might look great sitting quietly on a Figma frame, but
              feel awkward when interacting in the browser.
            </p>
            <p>
        ...
        <Section title="Validation" columns>
          <SubSection title="User Testing">
            <p>
              ...
              our tools and potential customers who had never heard of
              Pingboard. In addition, we started off with a round of internal
              testing so we could work out any obvious kinks before talking to
              other people.
            </p>
          ...
          <SubSection title="First Round of Results">
            <p>
              We gave each person a series of tasks and asked them to say what
              was going through their heads as they completed (or attempted to
          ...
          <p>
            After each cohort, we aggregated the results and found problem
            areas. If there were obvious solutions for them, I would make
            changes to the prototype before the next cohort to make sure they
          ...
          <div className="lg:col-start-2">
            <ul className="list-disc ml-16 space-y-16 mb-16">
              ...
              <li>
                ...
                <p className="text-primary-75">
                  Shunking these controls together saves space and helps
                  organize the toolbar. Additionally, we added breadcrumbs when
                  filtering to highlight your location.
                </p>
              </li>
              <li>
                <strong className="font-semibold">
                ...
                <p className="text-primary-75">
                  The zoom and Expand controls moved to the bottom of the
                  screen. These have hotkeys associated with them, plus
                  it&apos;s a fairly common place for other popular map-related
                  apps to place view controls (Google Maps, Apple Maps, etc.).
                </p>
              </li>
            </ul>
            <Button
